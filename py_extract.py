...
if __name__ == "__main__":
    # Example usage
    url = "https://cgi.cse.unsw.edu.au/~cs1521/23T3/topic/processes/code/"  # Replace with the actual URL
    ...
    if c_urls:
        ...
        if user_input.lower() == 'y':
            for url in c_urls:
                # Download the file
                download_file(url, "C:/Users/15617/Documents/92_MyGithub/CSAPP/ppt_process")
        else:
